...
-file("src/lustre/attribute.gleam", 181).
?DOC(
...
-spec closedby(binary()) -> lustre@vdom@vattr:attribute(any()).
closedby(Value) ->
    attribute(<<"closedby"/utf8>>, Value).

-file("src/lustre/attribute.gleam", 199).
?DOC(
...
-spec command(binary()) -> lustre@vdom@vattr:attribute(any()).
command(Value) ->
    attribute(<<"command"/utf8>>, Value).

-file("src/lustre/attribute.gleam", 208).
?DOC(
...
-spec commandfor(binary()) -> lustre@vdom@vattr:attribute(any()).
commandfor(Value) ->
    attribute(<<"commandfor"/utf8>>, Value).

-file("src/lustre/attribute.gleam", 225).
?DOC(
...
-file("src/lustre/attribute.gleam", 234).
?DOC(
...
-file("src/lustre/attribute.gleam", 252).
?DOC(
...
-file("src/lustre/attribute.gleam", 259).
?DOC(
...
-file("src/lustre/attribute.gleam", 284).
?DOC(
...
-file("src/lustre/attribute.gleam", 294).
?DOC(
...
-file("src/lustre/attribute.gleam", 303).
?DOC(
...
-file("src/lustre/attribute.gleam", 313).
?DOC(
...
-file("src/lustre/attribute.gleam", 334).
?DOC(
...
-file("src/lustre/attribute.gleam", 349).
?DOC(
...
-file("src/lustre/attribute.gleam", 357).
?DOC(
    " Used as part of the [Microdata](https://schema.org/docs/gs.html) format to\n"
...
-file("src/lustre/attribute.gleam", 365).
?DOC(
    " Used as part of the [Microdata](https://schema.org/docs/gs.html) format to\n"
...
-file("src/lustre/attribute.gleam", 374).
?DOC(
    " Used as part of the [Microdata](https://schema.org/docs/gs.html) format to\n"
...
-file("src/lustre/attribute.gleam", 392).
?DOC(
...
-file("src/lustre/attribute.gleam", 417).
?DOC(
...
-file("src/lustre/attribute.gleam", 425).
?DOC(
...
-file("src/lustre/attribute.gleam", 440).
?DOC(
...
-file("src/lustre/attribute.gleam", 458).
...
-file("src/lustre/attribute.gleam", 454).
?DOC(
...
-file("src/lustre/attribute.gleam", 486).
?DOC(
...
-file("src/lustre/attribute.gleam", 498).
?DOC(
...
-file("src/lustre/attribute.gleam", 529).
...
-file("src/lustre/attribute.gleam", 540).
...
-file("src/lustre/attribute.gleam", 574).
?DOC(
...
-file("src/lustre/attribute.gleam", 582).
?DOC(
...
-file("src/lustre/attribute.gleam", 589).
?DOC(
...
-file("src/lustre/attribute.gleam", 596).
?DOC(
...
-file("src/lustre/attribute.gleam", 614).
?DOC(
...
-file("src/lustre/attribute.gleam", 640).
?DOC(
...
-file("src/lustre/attribute.gleam", 652).
?DOC(
...
-file("src/lustre/attribute.gleam", 666).
?DOC(
...
-file("src/lustre/attribute.gleam", 676).
?DOC(
...
-file("src/lustre/attribute.gleam", 682).
...
-file("src/lustre/attribute.gleam", 710).
...
-file("src/lustre/attribute.gleam", 717).
?DOC(
...
-file("src/lustre/attribute.gleam", 723).
...
-file("src/lustre/attribute.gleam", 729).
...
-file("src/lustre/attribute.gleam", 743).
?DOC(
...
-file("src/lustre/attribute.gleam", 750).
?DOC(
...
-file("src/lustre/attribute.gleam", 767).
?DOC(
...
-file("src/lustre/attribute.gleam", 780).
?DOC(
...
-file("src/lustre/attribute.gleam", 792).
?DOC(
...
-file("src/lustre/attribute.gleam", 799).
?DOC(
...
-file("src/lustre/attribute.gleam", 824).
?DOC(
...
-file("src/lustre/attribute.gleam", 835).
?DOC(
...
-file("src/lustre/attribute.gleam", 880).
?DOC(
...
-file("src/lustre/attribute.gleam", 894).
?DOC(
...
-file("src/lustre/attribute.gleam", 907).
?DOC(
...
-file("src/lustre/attribute.gleam", 926).
?DOC(
...
-file("src/lustre/attribute.gleam", 932).
?DOC(
...
-file("src/lustre/attribute.gleam", 950).
?DOC(
...
-file("src/lustre/attribute.gleam", 957).
?DOC(
...
-file("src/lustre/attribute.gleam", 981).
?DOC(
...
-file("src/lustre/attribute.gleam", 990).
?DOC(
...
-file("src/lustre/attribute.gleam", 999).
?DOC(
...
-file("src/lustre/attribute.gleam", 1008).
?DOC(
...
-file("src/lustre/attribute.gleam", 1017).
?DOC(
...
-file("src/lustre/attribute.gleam", 1039).
?DOC(
...
-file("src/lustre/attribute.gleam", 1057).
?DOC(
...
-file("src/lustre/attribute.gleam", 1072).
?DOC(
...
-file("src/lustre/attribute.gleam", 1088).
?DOC(
    " Minimum value\n"
    "\n"
    " The following input types support the `\"max\"` attribute:\n"
...
-file("src/lustre/attribute.gleam", 1101).
?DOC(
...
-file("src/lustre/attribute.gleam", 1112).
?DOC(
...
-file("src/lustre/attribute.gleam", 1131).
?DOC(
...
-file("src/lustre/attribute.gleam", 1145).
?DOC(
...
-file("src/lustre/attribute.gleam", 1158).
?DOC(
...
-file("src/lustre/attribute.gleam", 1171).
?DOC(
...
-file("src/lustre/attribute.gleam", 1191).
?DOC(
...
-file("src/lustre/attribute.gleam", 1213).
?DOC(
...
-file("src/lustre/attribute.gleam", 1219).
?DOC(
...
-file("src/lustre/attribute.gleam", 1256).
?DOC(
    " Size of the control\n"
    "\n"
...
-file("src/lustre/attribute.gleam", 1272).
?DOC(
...
-file("src/lustre/attribute.gleam", 1319).
?DOC(
...
-file("src/lustre/attribute.gleam", 1326).
?DOC(
...
-file("src/lustre/attribute.gleam", 1333).
?DOC(
...
-file("src/lustre/attribute.gleam", 1354).
?DOC(
...
-file("src/lustre/attribute.gleam", 1361).
?DOC(
...
-file("src/lustre/attribute.gleam", 1368).
?DOC(
...
-file("src/lustre/attribute.gleam", 1418).
?DOC(
...
-file("src/lustre/attribute.gleam", 1425).
?DOC(
...
-file("src/lustre/attribute.gleam", 1432).
?DOC(
...
-file("src/lustre/attribute.gleam", 1439).
?DOC(
...
-file("src/lustre/attribute.gleam", 1450).
?DOC(
...
-file("src/lustre/attribute.gleam", 1458).
?DOC(
...
-file("src/lustre/attribute.gleam", 1465).
?DOC(
...
-file("src/lustre/attribute.gleam", 1474).
?DOC(
...
-file("src/lustre/attribute.gleam", 1486).
?DOC(
...
-file("src/lustre/attribute.gleam", 1495).
?DOC(
...
-file("src/lustre/attribute.gleam", 1523).
?DOC(
...
-file("src/lustre/attribute.gleam", 1529).
?DOC("\n").
-spec role(binary()) -> lustre@vdom@vattr:attribute(any()).
role(Name) ->
    attribute(<<"role"/utf8>>, Name).

-file("src/lustre/attribute.gleam", 1536).
?DOC(
...
-file("src/lustre/attribute.gleam", 1545).
?DOC(
...
-file("src/lustre/attribute.gleam", 1557).
?DOC(
...
-file("src/lustre/attribute.gleam", 1564).
?DOC(
...
-file("src/lustre/attribute.gleam", 1590).
?DOC(
...
-file("src/lustre/attribute.gleam", 1597).
?DOC(
...
-file("src/lustre/attribute.gleam", 1604).
?DOC(
...
-file("src/lustre/attribute.gleam", 1618).
?DOC(
...
-file("src/lustre/attribute.gleam", 1626).
?DOC(
...
-file("src/lustre/attribute.gleam", 1633).
?DOC(
...
-file("src/lustre/attribute.gleam", 1654).
?DOC(
...
-file("src/lustre/attribute.gleam", 1661).
?DOC(
...
-file("src/lustre/attribute.gleam", 1671).
?DOC(
...
-file("src/lustre/attribute.gleam", 1679).
?DOC(
...
-file("src/lustre/attribute.gleam", 1699).
?DOC(
...
-file("src/lustre/attribute.gleam", 1706).
?DOC(
...
-file("src/lustre/attribute.gleam", 1716).
?DOC(
...
-file("src/lustre/attribute.gleam", 1723).
?DOC(
...
-file("src/lustre/attribute.gleam", 1730).
?DOC(
...
-file("src/lustre/attribute.gleam", 1737).
?DOC(
...
-file("src/lustre/attribute.gleam", 1744).
?DOC(
...
-file("src/lustre/attribute.gleam", 1752).
?DOC(
...
-file("src/lustre/attribute.gleam", 1758).
...
-file("src/lustre/attribute.gleam", 1768).
?DOC(
...
-file("src/lustre/attribute.gleam", 1778).
?DOC(
...
-file("src/lustre/attribute.gleam", 1788).
?DOC(
...
-file("src/lustre/attribute.gleam", 1796).
?DOC(
...
-file("src/lustre/attribute.gleam", 1804).
?DOC(
...
-file("src/lustre/attribute.gleam", 1826).
?DOC(
...
-file("src/lustre/attribute.gleam", 1837).
?DOC(
...
-file("src/lustre/attribute.gleam", 1844).
?DOC(
...
-file("src/lustre/attribute.gleam", 1854).
?DOC(
...
-file("src/lustre/attribute.gleam", 1861).
?DOC(
...
-file("src/lustre/attribute.gleam", 1868).
?DOC(
...
-file("src/lustre/attribute.gleam", 1875).
?DOC(
...
-file("src/lustre/attribute.gleam", 1882).
?DOC(
...
-file("src/lustre/attribute.gleam", 1889).
?DOC(
...
-file("src/lustre/attribute.gleam", 1899).
?DOC(
...
-file("src/lustre/attribute.gleam", 1906).
?DOC(
...
-file("src/lustre/attribute.gleam", 1913).
?DOC(
...
-file("src/lustre/attribute.gleam", 1920).
?DOC(
...
-file("src/lustre/attribute.gleam", 1926).
...
-file("src/lustre/attribute.gleam", 1933).
?DOC(
