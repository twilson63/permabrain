...
?DOC("\n").
-spec merror(
    list(lustre@vdom@vattr:attribute(YBQ)),
    list(lustre@vdom@vnode:element(YBQ))
) -> lustre@vdom@vnode:element(YBQ).
...
?DOC("\n").
-spec mphantom(
    list(lustre@vdom@vattr:attribute(YBW)),
    list(lustre@vdom@vnode:element(YBW))
) -> lustre@vdom@vnode:element(YBW).
...
?DOC("\n").
-spec mprescripts(
    list(lustre@vdom@vattr:attribute(YCC)),
    list(lustre@vdom@vnode:element(YCC))
) -> lustre@vdom@vnode:element(YCC).
...
?DOC("\n").
-spec mrow(
    list(lustre@vdom@vattr:attribute(YCI)),
    list(lustre@vdom@vnode:element(YCI))
) -> lustre@vdom@vnode:element(YCI).
mrow(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mrow"/utf8>>,
...
?DOC("\n").
-spec mstyle(
    list(lustre@vdom@vattr:attribute(YCO)),
    list(lustre@vdom@vnode:element(YCO))
) -> lustre@vdom@vnode:element(YCO).
...
?DOC("\n").
-spec semantics(
    list(lustre@vdom@vattr:attribute(YCU)),
    list(lustre@vdom@vnode:element(YCU))
) -> lustre@vdom@vnode:element(YCU).
...
?DOC("\n").
-spec mmultiscripts(
    list(lustre@vdom@vattr:attribute(YDA)),
    list(lustre@vdom@vnode:element(YDA))
) -> lustre@vdom@vnode:element(YDA).
...
?DOC("\n").
-spec mover(
    list(lustre@vdom@vattr:attribute(YDG)),
    list(lustre@vdom@vnode:element(YDG))
) -> lustre@vdom@vnode:element(YDG).
...
?DOC("\n").
-spec msub(
    list(lustre@vdom@vattr:attribute(YDM)),
    list(lustre@vdom@vnode:element(YDM))
) -> lustre@vdom@vnode:element(YDM).
msub(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"msub"/utf8>>,
...
?DOC("\n").
-spec msubsup(
    list(lustre@vdom@vattr:attribute(YDS)),
    list(lustre@vdom@vnode:element(YDS))
) -> lustre@vdom@vnode:element(YDS).
...
?DOC("\n").
-spec msup(
    list(lustre@vdom@vattr:attribute(YDY)),
    list(lustre@vdom@vnode:element(YDY))
) -> lustre@vdom@vnode:element(YDY).
msup(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"msup"/utf8>>,
...
?DOC("\n").
-spec munder(
    list(lustre@vdom@vattr:attribute(YEE)),
    list(lustre@vdom@vnode:element(YEE))
) -> lustre@vdom@vnode:element(YEE).
...
?DOC("\n").
-spec munderover(
    list(lustre@vdom@vattr:attribute(YEK)),
    list(lustre@vdom@vnode:element(YEK))
) -> lustre@vdom@vnode:element(YEK).
...
?DOC("\n").
-spec mn(list(lustre@vdom@vattr:attribute(YFU)), binary()) -> lustre@vdom@vnode:element(YFU).
mn(Attrs, Text) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mn"/utf8>>,
...
?DOC("\n").
-spec mo(list(lustre@vdom@vattr:attribute(YFY)), binary()) -> lustre@vdom@vnode:element(YFY).
mo(Attrs, Text) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mo"/utf8>>,
...
?DOC("\n").
-spec mi(list(lustre@vdom@vattr:attribute(YGC)), binary()) -> lustre@vdom@vnode:element(YGC).
mi(Attrs, Text) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mi"/utf8>>,
...
?DOC("\n").
-spec mpadded(
    list(lustre@vdom@vattr:attribute(YGG)),
    list(lustre@vdom@vnode:element(YGG))
) -> lustre@vdom@vnode:element(YGG).
...
?DOC("\n").
-spec ms(list(lustre@vdom@vattr:attribute(YGM)), binary()) -> lustre@vdom@vnode:element(YGM).
ms(Attrs, Text) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"ms"/utf8>>,
...
?DOC("\n").
-spec mspace(list(lustre@vdom@vattr:attribute(YGQ))) -> lustre@vdom@vnode:element(YGQ).
mspace(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mspace"/utf8>>,
...
?DOC("\n").
-spec mtable(
    list(lustre@vdom@vattr:attribute(YGU)),
    list(lustre@vdom@vnode:element(YGU))
) -> lustre@vdom@vnode:element(YGU).
...
?DOC("\n").
-spec mtd(
    list(lustre@vdom@vattr:attribute(YHA)),
    list(lustre@vdom@vnode:element(YHA))
) -> lustre@vdom@vnode:element(YHA).
mtd(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mtd"/utf8>>,
...
?DOC("\n").
-spec mtext(list(lustre@vdom@vattr:attribute(YHG)), binary()) -> lustre@vdom@vnode:element(YHG).
mtext(Attrs, Text) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mtext"/utf8>>,
...
?DOC("\n").
-spec mtr(
    list(lustre@vdom@vattr:attribute(YHK)),
    list(lustre@vdom@vnode:element(YHK))
) -> lustre@vdom@vnode:element(YHK).
mtr(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/1998/Math/MathML"/utf8>>,
        <<"mtr"/utf8>>,
